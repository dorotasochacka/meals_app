...
const mealsList = [
  ...
  Meal(
    ...
    imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Schabowy_Gniezno.jpg/1920px-Schabowy_Gniezno.jpg',
    duration: 30,
    ingredients: [
    ...
    steps: [
      ...
      'Pair with young potatoes and a refreshing cucumber salad to create a legendary Polish Sunday dinner combination.'
    ],
    isGlutenFree: false,
    isVegan: false,
    isVegetarian: false,
